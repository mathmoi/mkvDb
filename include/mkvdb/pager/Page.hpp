...
namespace mkvdb::pager
{
    ...
    public:
        ...
        inline common::ByteSpan data() const { return common::ByteSpan(data_.get(), size_); }
        ...
        /// at the beginning of the page is reserved for the database header and is thus not
