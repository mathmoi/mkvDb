#ifndef MKVDB_TESTS_BTREE_BUILDERS_LEAF_NODE_BUILDER_HPP_
#define MKVDB_TESTS_BTREE_BUILDERS_LEAF_NODE_BUILDER_HPP_
...
namespace mkvdb::tests::btree::builders
{
    ...
    public:
        ...
        LeafNodeBuilder& WithItemsCount(std::uint32_t items_count)
        {
            items_count_ = items_count;
            return *this;
        }

        LeafNodeBuilder& WithKeySize(mkvdb::common::KeyValueSize key_size)
        {
            key_size_ = key_size;
            return *this;
        }

        LeafNodeBuilder& WithValueSize(mkvdb::common::KeyValueSize value_size)
        {
            value_size_ = value_size;
            return *this;
        }

        LeafNodeBuilder& WithPageSize(mkvdb::pager::Page::PageSize page_size)
        {
            page_size_ = page_size;
            return *this;
        }

        LeafNodeBuilder& WithPageIndex(mkvdb::pager::Page::PageIndex page_index)
        {
            page_index_ = page_index;
            return *this;
        }

        mkvdb::btree::LeafNode& Build()
        {
            if(!node_)
            {
    ...
    private:
        ...
        std::optional<mkvdb::btree::LeafNode> node_;
    };

} // namespace mkvdb::tests::btree::builders

#endif // MKVDB_TESTS_BTREE_BUILDERS_LEAF_NODE_BUILDER_HPP_